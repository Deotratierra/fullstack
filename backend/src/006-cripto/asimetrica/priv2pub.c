...
/** Calcula y devuelve la clave pública asociada a la clave privada
 * pasada como parámetro. Las claves de entrada y de salida son
 * en formato hexadecimal. La salida es una cadena terminada
 * en NULL.
...
{
  /* Obtenemos la clave privada de la línea de comandos y calculamos
  la clave pública. La clave privada debe estar en formato hexadecimal
  y contener 64 caracteres. Para probar, podemos generar una clave en
  https://www.bitaddress.org (ir a "Wallet details", ahí está en hexadecimal). */
