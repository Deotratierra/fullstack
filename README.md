## FULLSTACK
Referencia de programación en español backend + frontend.
...
- [Perfilar código](https://github.com/mondeja/fullstack/tree/master/backend/src/024-profile) (py, js, go, rb, sh, c, cpp, ipynb)
